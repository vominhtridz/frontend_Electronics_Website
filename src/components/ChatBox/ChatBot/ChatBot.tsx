...
const ChatBot = () => {
  return (
    <section className='fixed max-w-[640px] z-20 w-[640px] h-[570px] max-h-[570px]  transition duration-900 right-4 bottom-0  rounded-lg shadow-xl  bg-white text-[13.5px] text-slate-600'>
